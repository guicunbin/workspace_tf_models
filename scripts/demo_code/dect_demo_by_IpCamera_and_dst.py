...
#IP_video="http://guicunbin:123456@10.112.117.136:8081/"
IP_video="http://guicunbin:123456@10.210.72.231:8081/"
...
#PATH_TO_CKPT = '/home/guicunbin/workspace/models/research/my_workspace/models/ssd_mobilenet_v1_pets/inference/frozen_inference_graph.pb'
#PATH_TO_CKPT = '/home/guicunbin/workspace/TF_ckpt/ssd_mobilenet_v1_coco_2017_11_17/frozen_inference_graph.pb'
#PATH_TO_CKPT = '/home/guicunbin/workspace/TF_ckpt/ssdlite_mobilenet_v2_coco_2018_05_09/frozen_inference_graph.pb'
#PATH_TO_CKPT = '/home/guicunbin/workspace/TF_ckpt/faster_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb'
#PATH_TO_CKPT = '/home/guicunbin/workspace/TF_ckpt/faster_rcnn_inception_resnet_v2_atrous_lowproposals_oid_2018_01_28/frozen_inference_graph.pb'
PATH_TO_CKPT = '/home/guicunbin/workspace/TF_ckpt/faster_rcnn_resnet101_ava_v2.1_2018_04_30/frozen_inference_graph.pb'
...
with detection_graph.as_default():
    ...
    IP_capture =cv2.VideoCapture(IP_video)
    while(True):
        #image = get_img_from_socket(src)
        success, image = IP_capture.read()
