...
Session_config.gpu_options.per_process_gpu_memory_fraction = 0.30 #0.22



def main(submit_file, log_file, graph_path, label_path, test_image_dir, DC_dect_cate_list=(3,5,6,7,8,9,62), DC_dect_score_min="0.5", is_socked="0",TCP_PORT=9999):
    print locals();
    ...
    if is_socked:
        sock = create_server_socket(TCP_IP=get_local_IP(), TCP_PORT=TCP_PORT)
        ...
        for image_name in test_image_names:
            ...
            if is_socked:
                ...
                DC_car_dect_write_one_line_to_submit(f_write, image_copy, image_name, image_H, image_W, output_dict, 
                        dect_cate_list = DC_dect_cate_list, dect_score_min = DC_dect_score_min, show_box_on_image=is_socked);
